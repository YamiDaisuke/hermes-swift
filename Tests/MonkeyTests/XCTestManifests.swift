...
extension CompilableValuesTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__CompilableValuesTests = [
        ...
        ("testFunctionCompile", testFunctionCompile),
        ("testFunctionDecompile", testFunctionDecompile),
        ...
        ("testMArrayDecompile", testMArrayDecompile),
        ("testMFloatCompile", testMFloatCompile),
        ("testMFloatDecompile", testMFloatDecompile),
...
extension MonkeyCompilerTests {
    ...
    static let __allTests__MonkeyCompilerTests = [
        ...
        ("testCompiledConstants", testCompiledConstants),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(CompilableValuesTests.__allTests__CompilableValuesTests),
